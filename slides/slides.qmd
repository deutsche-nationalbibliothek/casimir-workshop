...
knitr::opts_chunk$set(
  ...
  fig.path = "figures/01_set-retrieval-metrics/"
  )
...
## Practical I
  ...
  **Practical:** Go to `workbooks/00_inspecting-results-manually.qmd` to inspect the
...
## Practical II
  ...
  **Practical:** Go to `workbooks/01_set-retrieval-metrics.qmd` to compute
...
**Practical:** Go to `workbooks/02_stratified-set-retrieval-metrics.qmd` to explore
...
## Practical IV: Precision Recall Curves
  ...
  **Practical:** Go to `workbooks/03_precision-recall-curves.qmd` to compute
...
## Practical V: Long Tail Analysis
  ...
  **Practical:** Go to `workbooks/04_analysing-the-long-tail.qmd` to analyse
   performance of subject indexing methods on frequent vs. rare labels.

## Practical VI: Final Assignment

  **Practical:** Go to `workbooks/05_final-assignment.qmd` and try to solve todays quiz:
