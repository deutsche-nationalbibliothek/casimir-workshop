...
functions to dissect results on the intermediate aggregation level. 
...
wrapper around three steps:
  ...
  2. `compute_intermediate_results()`: computes true positives, false positives, 
    ...
    subject).
  3. `summarise_intermediate_results()` computes averages of the intermediate 
...
for documents or subject terms with no predictions, if they have occurrences in 
the gold standard. 
